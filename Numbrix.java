...
public class Numbrix
{
 ...
 public Numbrix(String fileName) throws FileNotFoundException
 {
   ...
   //TODO: instantiate grid2D to have the appropriate rows and columns
   //TODO: instantiate used to have rows * cols + 1 elements
   //TODO: Populate grid and used with values using s.nextInt()
   //      used[num] should be true if num is in the original input puzzle.
